...
MESSAGES = {
    ...
    'WEBHOOK_NOT_VERIFIED': 'Webhook check failed. Task owner can review detailed payload and response in Notifications.',
    'WEBHOOK_REQUEST_FAILED': 'Webhook check failed due to endpoint/network error. Task owner can review details in Notifications.',
    'WEBHOOK_BAD_JSON': 'Webhook response was invalid JSON. Task owner can review details in Notifications.',
