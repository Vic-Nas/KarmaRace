MESSAGES = {
    ...
    'PH_POST_NOT_FOUND': 'Product Hunt post not found. Use post slug.',
    'PH_VOTE_CHECK_FAILED': 'Product Hunt vote check failed: {error}',
    'PH_COMMENT_CHECK_FAILED': 'Product Hunt comment check failed: {error}',
    'PH_ENGAGEMENT_VERIFIED': 'Verified Product Hunt upvote and comment.',
    'PH_BOTH_REQUIRED': 'Both Product Hunt upvote and comment are required.',
